...
import com.primogemstudio.engine.bindings.vulkan.core.Vk10Funcs.VK_STRUCTURE_TYPE_FENCE_CREATE_INFO
...
class VkFenceCreateInfo(private val seg: MemorySegment) : IHeapObject(seg) {
    companion object {
