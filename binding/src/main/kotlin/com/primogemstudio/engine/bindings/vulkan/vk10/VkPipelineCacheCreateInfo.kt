...
import com.primogemstudio.engine.bindings.vulkan.vk10.Vk10Funcs.VK_STRUCTURE_TYPE_PIPELINE_CACHE_CREATE_INFO
...
class VkPipelineCacheCreateInfo(private val seg: MemorySegment) : IHeapObject(seg) {
    companion object {
