...
import com.primogemstudio.engine.bindings.vulkan.vk10.Vk10Funcs.VK_STRUCTURE_TYPE_BUFFER_VIEW_CREATE_INFO
...
class VkBufferViewCreateInfo(private val seg: MemorySegment) : IHeapObject(seg) {
    companion object {
    ...
    var buffer: VkBuffer
        get() = VkBuffer(seg.get(ADDRESS, OFFSETS[3]))
