...
import com.primogemstudio.engine.bindings.vulkan.vk10.Vk10Funcs.VK_STRUCTURE_TYPE_PIPELINE_DYNAMIC_STATE_CREATE_INFO
...
class VkPipelineDynamicStateCreateInfo(private val seg: MemorySegment) : IHeapObject(seg) {
    companion object {
    ...
    var dynamicStates: HeapIntArray
        get() = HeapIntArray(
