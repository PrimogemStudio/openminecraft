...
import com.primogemstudio.engine.bindings.vulkan.vk10.Vk10Funcs.VK_STRUCTURE_TYPE_COMMAND_POOL_CREATE_INFO
...
class VkCommandPoolCreateInfo(private val seg: MemorySegment) : IHeapObject(seg) {
    companion object {
