...
class VkPipelineLayoutCreateInfo(
    ...
    private val setLayouts: HeapPointerArray<VkDescriptorSetLayout>? = null,
    ...
    override fun construct(seg: MemorySegment) {
        ...
        seg.set(JAVA_INT, OFFSETS[3], setLayouts?.length ?: 0)
        seg.set(ADDRESS, OFFSETS[4], setLayouts?.ref() ?: MemorySegment.NULL)
