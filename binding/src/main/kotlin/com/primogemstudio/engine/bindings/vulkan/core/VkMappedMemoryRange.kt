...
import com.primogemstudio.engine.bindings.vulkan.core.Vk10Funcs.VK_STRUCTURE_TYPE_MAPPED_MEMORY_RANGE
...
class VkMappedMemoryRange(private val seg: MemorySegment) : IHeapObject(seg) {
    companion object {
