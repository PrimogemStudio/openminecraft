...
import com.primogemstudio.engine.bindings.vulkan.core.Vk10Funcs.VK_STRUCTURE_TYPE_EVENT_CREATE_INFO
...
class VkEventCreateInfo(private val seg: MemorySegment) : IHeapObject(seg) {
    companion object {
