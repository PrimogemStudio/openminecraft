...
class VkGraphicsPipelineCreateInfo(
    ...
    override fun construct(seg: MemorySegment) {
        ...
        seg.set(ADDRESS, OFFSETS[5], vertex?.ref() ?: MemorySegment.NULL)
        seg.set(ADDRESS, OFFSETS[6], inputAssembly?.ref() ?: MemorySegment.NULL)
        seg.set(ADDRESS, OFFSETS[7], tessellation?.ref() ?: MemorySegment.NULL)
        ...
        seg.set(ADDRESS, OFFSETS[12], colorBlend?.ref() ?: MemorySegment.NULL)
