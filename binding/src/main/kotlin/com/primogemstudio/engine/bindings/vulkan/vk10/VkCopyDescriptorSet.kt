...
import com.primogemstudio.engine.bindings.vulkan.vk10.Vk10Funcs.VK_STRUCTURE_TYPE_COPY_DESCRIPTOR_SET
...
class VkCopyDescriptorSet(private val seg: MemorySegment) : IHeapObject(seg) {
    companion object {
    ...
    var dstSet: VkDescriptorSet
        get() = VkDescriptorSet(seg.get(ADDRESS, OFFSETS[5]))
