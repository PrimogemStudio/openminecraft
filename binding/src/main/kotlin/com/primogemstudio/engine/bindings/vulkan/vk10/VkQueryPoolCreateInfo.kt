...
import com.primogemstudio.engine.bindings.vulkan.vk10.Vk10Funcs.VK_STRUCTURE_TYPE_QUERY_POOL_CREATE_INFO
...
class VkQueryPoolCreateInfo(private val seg: MemorySegment) : IHeapObject(seg) {
    companion object {
