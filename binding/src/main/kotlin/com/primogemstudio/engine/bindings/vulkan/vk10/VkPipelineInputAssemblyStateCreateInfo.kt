...
import com.primogemstudio.engine.bindings.vulkan.vk10.Vk10Funcs.VK_STRUCTURE_TYPE_PIPELINE_INPUT_ASSEMBLY_STATE_CREATE_INFO
...
class VkPipelineInputAssemblyStateCreateInfo(private val seg: MemorySegment) : IHeapObject(seg) {
    companion object {
