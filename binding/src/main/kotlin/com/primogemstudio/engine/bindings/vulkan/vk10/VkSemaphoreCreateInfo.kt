...
import com.primogemstudio.engine.bindings.vulkan.vk10.Vk10Funcs.VK_STRUCTURE_TYPE_SEMAPHORE_CREATE_INFO
...
class VkSemaphoreCreateInfo(private val seg: MemorySegment) : IHeapObject(seg) {
    companion object {
    ...
    constructor() : this(Arena.ofAuto().allocate(VkBufferViewCreateInfo.LAYOUT)) {
