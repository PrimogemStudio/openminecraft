...
import com.primogemstudio.engine.bindings.vulkan.vk10.Vk10Funcs.VK_STRUCTURE_TYPE_MEMORY_BARRIER
...
class VkMemoryBarrier(private val seg: MemorySegment) : IHeapObject(seg) {
    companion object {
