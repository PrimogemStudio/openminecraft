...
import com.primogemstudio.engine.bindings.vulkan.vk10.Vk10Funcs.VK_STRUCTURE_TYPE_DESCRIPTOR_SET_ALLOCATE_INFO
...
class VkDescriptorSetAllocateInfo(private val seg: MemorySegment) : IHeapObject(seg) {
    companion object {
    ...
    var descriptorPool: VkDescriptorPool
        get() = VkDescriptorPool(seg.get(ADDRESS, OFFSETS[2]))
    ...
    fun count(): Int = seg.get(JAVA_INT, OFFSETS[3])
}